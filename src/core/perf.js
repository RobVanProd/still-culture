...
/** Target: 60 Hz with headroom. Everything is milliseconds. */
export const BUDGET = {
  frameMedian: 16.7,
  frameP95: 20.0,
  frameP99: 25.0,
  hitch: 50.0,     // any frame this long is a defect, counted individually
  update: 4.0,     // simulation only
  render: 8.0,     // draw submission only
};
